          ...
          Try
            ...
            If webResponse.StatusCode = HttpStatusCode.OK Then
              ...
              For Each linea In oPedido.items
                ...
                End If
                'JASF (10/08/2022): El descuento a nivel de línea será: discount_ammount - discount_tax_compensation_amount
...
#Region "Sincronización de Artículos (SAP a Magento)"
...
#Region "Sincronización de Clientes (SAP a Magento)"
...
#Region "Sincronización de Precios (SAP a Magento)"
